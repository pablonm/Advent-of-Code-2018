...
maxSleepGuard = _.maxBy(hoursByGuard, g => { return g.totalSleep; });
maxSleepMinute = maxSleepGuard.sleepByHour.indexOf(_.maxBy(maxSleepGuard.sleepByHour, h => h))
console.log(maxSleepGuard.id * maxSleepMinute)
